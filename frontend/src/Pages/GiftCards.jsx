...
export const GiftCards = () => {
    ...
    const handlePurchaseGiftCard = async () => {
        ...
        try {
            ...
            const response = await fetch(
                `${API_BASE_URL}/gift-cards/purchase`,
                {
                    ...
                    body: JSON.stringify({
                        ...
                        message:
                            message ||
                            `Enjoy movies with MovieTix! From ${senderName}`,
                    }),
                },
            );
            ...
            if (result.success) {
                alert(
                    `Gift card purchased successfully! Code: ${result.giftCard.code}`,
                );
                // Reset form
                setRecipientEmail("");
                setRecipientName("");
            ...
            if (error.name === "TypeError" && error.message.includes("fetch")) {
                ...
                alert(
                    "API endpoint not found. Please check backend implementation.",
                );
            } else {
    ...
    const handleRedeemGiftCard = async () => {
        ...
        try {
            ...
            if (response.ok && result.success) {
                alert(
                    `Gift card redeemed successfully! ₹${result.amount} added to your wallet.`,
                );
                setRedeemCode("");
                fetchWalletBalance();
                fetchGiftCardHistory();
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                        Give the gift of entertainment! Perfect for birthdays,
                    ...
                    <div className="max-w-md mx-auto bg-white rounded-2xl shadow-xl p-8">
                        <div className="text-center mb-6">
                            ...
                            <p className="text-gray-600 mt-2">
                                Enter your gift card code to add balance to your
                                wallet
                            </p>
                        </div>
                        ...
                        {giftCardHistory.length > 0 ? (
                            ...
                            <div className="text-center py-12">
                                ...
                                <p className="text-gray-500">
                                    Purchase or receive gift cards to see them
                                    here
                                </p>
                            </div>
                        )}
