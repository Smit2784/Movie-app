    ...
    const teamMembers = [
        {
            name: "Smit  Dudhat",
            role: "CEO & Founder",
            image: "https://cdn.images.express.co.uk/img/dynamic/79/940x/secondary/Paul-is-best-known-for-playing-Arthur-Shelby-5237845.avif?r=1709074164477",
            description:
        ...
        },
        {
            ...
            image: "https://i2-prod.walesonline.co.uk/article23499865.ece/ALTERNATES/s1200f/0_Peaky-Blinders-SERIES-4.jpg",
            description:
            ...
            <div className="bg-linear-to-r from-purple-900 via-blue-900 to-indigo-900 text-white py-20">
                <div className="container mx-auto px-6 text-center">
                    ...
                    <p className="text-xl lg:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
                        We're on a mission to make movie-going magical. From
                        finding the perfect show to booking the best seats,
                        we're here to enhance your cinematic journey.
                    </p>
                </div>
            </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div>
                        ...
                        <p className="text-lg text-gray-600 leading-relaxed mb-6">
                            Founded in 2020, MovieTix started with a simple
                            belief: booking movie tickets shouldn't be
                            complicated. What began as a small startup has grown
                            into India's most loved movie booking platform,
                            serving millions of movie enthusiasts across the
                            country.
                        </p>
                        <p className="text-lg text-gray-600 leading-relaxed">
                            We've revolutionized the way people discover, book,
                            and enjoy movies by combining cutting-edge
                            technology with a deep understanding of what movie
                            lovers truly want.
                        </p>
                    </div>
