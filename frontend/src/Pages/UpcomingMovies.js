                ...
                <div className="relative container mx-auto px-6 py-24">
                    <div className="text-center max-w-6xl mx-auto">
                        ...
                        <p className="text-xl lg:text-2xl mb-16 text-gray-300 max-w-3xl mx-auto leading-relaxed font-light">
                            Get ready for the most anticipated movies coming to
                            theaters. From superhero epics to heartwarming
                            dramas - the future of cinema awaits.
                        </p>
                ...
                <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between mb-16">
                    <div className="mb-8 lg:mb-0">
                        ...
                        <p className="text-xl text-gray-600 max-w-2xl">
                            Be the first to experience the most awaited movies
                            of the year
                        </p>
