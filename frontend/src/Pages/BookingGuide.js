            ...
            <div className="bg-gradient-to-r from-purple-900 via-blue-900 to-indigo-900 text-white py-16">
                <div className="container mx-auto px-6 text-center">
                    ...
                    <p className="text-xl lg:text-2xl text-gray-300 leading-relaxed max-w-4xl mx-auto">
                        Learn how to book your favorite movies in just 5 simple
                        steps
                    </p>
                </div>
            </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <div className="p-8 lg:p-12">
                                ...
                                <div className="space-y-4">
                                    {bookingSteps[currentStep].details.map(
                                        (detail, index) => (
                                            <div
                                                key={index}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div className="text-center">
                            ...
                            <p className="text-gray-600 text-sm">
                                Skip payment forms and book instantly with your
                                wallet balance
                            </p>
                        </div>
                        <div className="text-center">
                            ...
                            <p className="text-gray-600 text-sm">
                                Reserve your favorite seats early, especially
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-gray-600 text-sm">
                                Read ratings and reviews before booking your
                                tickets
                            </p>
                        </div>
                    </div>
