...
export const AdminBookings = ({ onBack }) => {
    ...
    const totalRevenue = bookings.reduce(
        (acc, curr) => acc + (curr.status === "confirmed" ? curr.totalAmount : 0),
        0
    );
            ...
            <nav className="mb-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <div className="flex items-center gap-4 animate-fadeIn">
                    <div className="text-right hidden sm:block">
                        <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Net confirmed</p>
            ...
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                <div className="animate-fadeIn">
                    <h2 className="text-4xl font-black text-slate-900 tracking-tight">
                        Booking <span className="text-slate-400 italic font-light">Ledger</span>
                    </h2>
                ...
                {/* Table Container */}
                <div className="bg-white rounded-[2.5rem] shadow-2xl shadow-slate-200/50 border border-white overflow-hidden animate-fadeIn" style={{ animationDelay: '100ms' }}>
                    {loading ? (
                            ...
                            <table className="w-full text-left border-collapse">
                                <thead>
                                    <tr className="bg-slate-50/50 border-b border-slate-100">
                                        ...
                                        <th className="p-6 text-[10px] font-black text-slate-400 uppercase tracking-widest">Movie</th>
                                        <th className="p-6 text-[10px] font-black text-slate-400 uppercase tracking-widest">Showtime</th>
                                        ...
                                        >
                                            ...
                                            <td className="p-6">
                                                {booking.show && booking.show.movie ? (
                                                    ...
                                                    <div className="flex items-center gap-2 text-rose-400 font-bold text-xs uppercase italic">
                                                        <XCircle size={14} /> Deleted Content
                                                    </div>
                                                )}
                                            </td>
                                                ...
                                                {booking.show ? (
                                                    <div className="space-y-1.5">
                                                        <p className="text-xs font-black text-slate-600 flex items-center gap-2">
                                                            ...
                                                            {booking.show.theater ? booking.show.theater.name : "Unassigned"}
                                                        </p>
                                                        <p className="text-[10px] font-bold text-slate-400 flex items-center gap-2 uppercase tracking-tighter">
                                                            <Calendar size={12} />
                                                            {new Date(booking.show.date).toLocaleDateString(undefined, { month: 'short', day: 'numeric' })}
                                                            <span className="text-slate-200">|</span>
                                                            <span className="text-slate-500">{booking.show.time}</span>
                                                        </p>
                                                    </div>
                                                ) : (
                                                    <span className="text-slate-300 text-[10px] font-black uppercase">Schedule Purged</span>
                                                )}
                                            </td>
                                            ...
                                            <td className="p-6">
                                                <div className="flex flex-wrap justify-center gap-1.5 max-w-[120px] mx-auto">
                                                    {booking.seats && booking.seats.length > 0
                                                        ...
                                                        : <span className="text-slate-400 text-xs font-bold">{booking.seats}</span>}
                                                </div>
                                            </td>
                                            ...
                                            <td className="p-6">
                                                <div className="flex flex-col">
                                                    ...
                                                    <span className="text-[9px] font-black text-slate-300 uppercase tracking-widest">Gross total</span>
                                                </div>
                                            </td>

                                            {/* Status Badge */}
                                            <td className="p-6 text-right">
                                                <div className={`inline-flex items-center gap-2 pl-2 pr-4 py-1.5 rounded-full border-2 ${
                                                    ...
                                                    <div className={`p-1 rounded-full ${booking.status === "confirmed" ? "bg-emerald-500" : "bg-rose-500"} text-white`}>
                                        ...
                                        <tr>
                                            <td colSpan="6" className="p-20 text-center">
                                                <div className="flex flex-col items-center opacity-20">
                                                    ...
                                                    <p className="font-black uppercase tracking-[0.3em] text-sm">Zero Transactions Logged</p>
                                                </div>
                                            </td>
                                        </tr>
                                    )}
