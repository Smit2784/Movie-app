                                        ...
                                        >
                                            ...
                                            <td className="p-6 text-center">
                                                <select
                                                    ...
                                                    className={`outline-none cursor-pointer appearance-none text-center inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest border-2 transition-all ${
                                                        u.role === "admin"
