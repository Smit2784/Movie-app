            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100 h-fit sticky top-8">
                    <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-100">
                        <div
                            className={`p-3 rounded-xl ${isEditing ? "bg-orange-100 text-orange-600" : "bg-emerald-100 text-emerald-600"}`}
                        >
                            {isEditing ? (
                                <Edit size={24} />
                            ) : (
                    ...
                    <form onSubmit={handleAdd} className="space-y-4">
                        <input
                            ...
                            className="w-full p-3 bg-gray-50 border-gray-200 rounded-xl focus:ring-2 focus:ring-emerald-500 outline-none transition"
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full p-3 pl-10 bg-gray-50 border-gray-200 rounded-xl focus:ring-2 focus:ring-emerald-500 outline-none transition"
                        ...
                        <div className="flex gap-3 pt-4">
                            ...
                            <button
                                type="submit"
                                className={`flex-1 ${isEditing ? "bg-orange-500 hover:bg-orange-600" : "bg-emerald-600 hover:bg-emerald-700"} text-white py-3 rounded-xl font-bold transition shadow-lg shadow-emerald-200`}
                            >
                                {isEditing
                                    ? "Update Theater"
                                    : "Create Theater"}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {theaters.length > 0 ? (
                            theaters.map((theater) => (
                                <div
                                    key={theater._id}
                                    className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:border-emerald-200 hover:shadow-md transition group relative overflow-hidden"
                                >
                            ...
                            <div className="col-span-2 text-center py-12 bg-white rounded-2xl border border-dashed border-gray-300">
                                <p className="text-gray-500">
                                    No theaters found. Add one to get started.
                                </p>
                            </div>
                        )}
                    </div>
