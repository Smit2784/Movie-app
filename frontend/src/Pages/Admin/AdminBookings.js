                ...
                <div className="flex items-center justify-between mb-8">
                    <div>
                        ...
                        <p className="text-gray-500 mt-1">
                            View all user transactions and bookings
                        </p>
                    </div>
                    <div className="bg-white px-4 py-2 rounded-xl shadow-sm border border-gray-100">
                        ...
                        <span className="text-green-600 font-bold ml-1 text-lg">
                            ₹
                            {bookings
                                .reduce(
                                    (acc, curr) =>
                                ...
                                <tbody className="divide-y divide-gray-50">
                                    {bookings.map((booking) => (
                                        ...
                                        >
                                            ...
                                            <td className="p-5">
                                                <span
                                                    className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold border ${booking.status === "confirmed" ? "bg-green-50 text-green-700 border-green-100" : "bg-red-50 text-red-700 border-red-100"}`}
                                                >
                                                    {booking.status ===
                                                    "confirmed" ? (
                                                        <CheckCircle
