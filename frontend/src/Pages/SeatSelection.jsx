...
export const SeatSelection = ({ show, onSeatSelect, selectedSeats }) => {
    ...
    const generateSeats = () => {
        ...
        const getRowLetter = (r) => {
            let letter = "";
            let tempR = r;
            while (tempR >= 0) {
                letter = String.fromCharCode(65 + (tempR % 26)) + letter;
        ...
        for (let r = 0; r < numRows; r++) {
            ...
            const seatsInThisRow =
                isLastRow && totalCapacity % seatsPerRow !== 0
            ...
            for (let i = 1; i <= seatsInThisRow; i++) {
                ...
                seats.push({
                    ...
                    number: i,
                    isBooked:
                        currentShow.bookedSeats?.includes(seatId) || false,
        ...
        <div className="bg-linear-to-br from-white to-gray-50 p-8 rounded-3xl shadow-2xl max-w-6xl mx-auto border border-gray-100">
                        ...
                        <div className="flex space-x-2">
                            {rowSeats.map((seat) => (
                                <button
                                    ...
                                    onClick={() =>
                                        !seat.isBooked && onSeatSelect(seat.id)
                                    }
                                    className={`
            ...
            <div className="mt-6 text-center">
                <p className="text-sm text-gray-500">
                    Click on available seats to select • Maximum 10 seats per
                    booking • Real-time availability updates
                </p>
            </div>
        </div>
    );
