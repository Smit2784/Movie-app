...
const api = {
  ...
  getUpcomingMovies: async (categories, search) => {
    try {
      ...
      console.log("🔍 Fetching upcoming movies with params:", params.toString());
      const response = await fetch(`${API_BASE_URL}/upcoming-movies?${params}`);
      
      if (!response.ok) {
        throw new Error(`HTTP ${response.status}: Failed to fetch upcoming movies`);
      }
  ...
  getUpcomingMovie: async (id) => {
    try {
      ...
      if (!response.ok) {
        throw new Error(`HTTP ${response.status}: Failed to fetch upcoming movie`);
      }
      return response.json();
    } catch (error) {
    ...
    if (submitted) {
      return (
        <div className="text-center">
          ...
          <h3 className="text-2xl font-bold text-gray-700 mb-4">You're on the list!</h3>
          <p className="text-gray-600 text-lg">
    ...
    return (
      <div className="text-center">
        ...
        <p className="text-gray-600 text-lg leading-relaxed mb-8">
          This movie releases on <strong>{new Date(movie.releaseDate).toLocaleDateString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}</strong>.
          <br />
...
// Enhanced Movie Card for Upcoming Movies (Modified version of your card)
    ...
    >
      <div className="relative overflow-hidden">
        ...
        <img
          ...
          onLoad={() => setImageLoaded(true)}
          onError={(e) => {
            e.target.src = 'https://via.placeholder.com/300x450/6366f1/ffffff?text=Coming+Soon';
            setImageLoaded(true);
          }}
        />
        ...
        {/* Status Badge */}
        <div className={`absolute top-4 left-4 ${getStatusColor(movie.status)} text-white px-3 py-1 rounded-full text-sm font-bold`}>
          {movie.status}
        </div>
  ...
  useEffect(() => {
    const fetchUpcomingMovies = async () => {
      ...
      try {
        ...
        const categories = selectedCategory !== 'All' ? [selectedCategory] : null;
    ...
    try {
      ...
      if (result.success) {
        if (result.skipReason === 'already_exists') {
          alert(`${result.moviesCount} upcoming movies already exist in the database!`);
        } else {
          alert(`Successfully added ${result.moviesCount} upcoming movies to the database!`);
        }
      ...
      alert(`Error seeding upcoming movies:\n${error.message}\n\nCheck the browser console for more details.`);
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <h3 className="text-2xl font-bold text-gray-700 mb-2">Loading Upcoming Movies</h3>
          <p className="text-gray-500 animate-pulse">Fetching from database...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="relative bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 text-white overflow-hidden">
        ...
        <div className="relative container mx-auto px-6 py-24">
          <div className="text-center max-w-6xl mx-auto">
            ...
            <p className="text-xl lg:text-2xl mb-16 text-gray-300 max-w-3xl mx-auto leading-relaxed font-light">
              Get ready for the most anticipated movies coming to theaters. From superhero epics to heartwarming dramas - the future of cinema awaits.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 group">
                ...
                <div className="text-gray-200 font-medium text-lg">Upcoming Movies</div>
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 group">
                ...
                <div className="text-gray-200 font-medium text-lg">More Coming</div>
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 group">
                ...
                <div className="text-gray-200 font-medium text-lg">Early Access</div>
                <div className="text-gray-400 text-sm mt-2">Book in advance</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between mb-16">
          <div className="mb-8 lg:mb-0">
            ...
            {upcomingMovies.length > 0 && (
              <div className="mt-6">
                <p className="text-gray-600">
                  Showing <span className="font-semibold text-purple-600">{upcomingMovies.length}</span> upcoming movies
        ...
        {error && (
          <div className="text-center py-24">
            <div className="max-w-lg mx-auto">
              ...
              <h3 className="text-3xl font-bold text-gray-700 mb-4">Error Loading Movies</h3>
        ...
        {!error && upcomingMovies.length === 0 ? (
          <div className="text-center py-24">
            <div className="max-w-lg mx-auto">
              ...
              <h3 className="text-3xl font-bold text-gray-700 mb-4">No Upcoming Movies Found</h3>
              <p className="text-lg text-gray-500 mb-10 leading-relaxed">
                {searchTerm || selectedCategory !== 'All' 
                  ? "Try adjusting your search terms or browse all categories"
